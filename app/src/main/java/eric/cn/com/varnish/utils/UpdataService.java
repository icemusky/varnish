...
public class UpdataService extends Service {
    ...
    private void initDownManager() {
        ...
        // 设置下载后文件存放的位置
        down.setDestinationInExternalPublicDir(DOWNLOADPATH, "youjian.apk");
        down.setTitle("youjian");
        // 将下载请求放入队列
...
private String path;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        path= Environment.getExternalStorageDirectory().getAbsolutePath() +DOWNLOADPATH+ "youjian.apk";
