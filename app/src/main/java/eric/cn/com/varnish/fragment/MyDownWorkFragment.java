...
import eric.cn.com.varnish.adapter.MyWeekDownItemAdapter;
...
public class MyDownWorkFragment extends Fragment {
    private View view;
    private List<MyWorkBean.Line2Bean.SiteBeanX> data;
    private MyListView my_lv;
    private MyWeekDownItemAdapter adapter;
    ...
    private void getBus() {
        ...
        x.http().post(params, new HttpCallBack<MyWorkBean>(new IAsyncHttpComplete<MyWorkBean>() {
            ...
            public void onSuccess(MyWorkBean result) {
                ...
                Log.i("MyDownWorkFragment", new Gson().toJson(result.toString()));
            }
    ...
    private void bindData(MyWorkBean bean) {
        ...
        data = new ArrayList<>();
        data.addAll(bean.getLine2().getSite());
        adapter = new MyWeekDownItemAdapter(getActivity(), data);
